...
| POST | `/api/v1/auth/student/register` | public | Student self-registration (only when enabled in system settings) |
...
| POST | `/api/v1/students/:id/reset-password` | SUPER_ADMIN/OWNER | Set a new password for a student (ends all sessions) |
